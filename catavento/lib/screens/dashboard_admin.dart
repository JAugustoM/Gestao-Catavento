      ...
      child: _demandas.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return DemandCard(
                  nomeDemanda: demanda['nomeDemanda'] ?? 'Nome não disponível', // Valor padrão
                  status: demanda['status'] ?? 'Status não disponível', // Valor padrão
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text('Código: ${codigo.isNotEmpty ? codigo : 'Sem código'}\nStatus: $status'),
        trailing: Row(
              ...
              onPressed: () {
                onPressed: () async {
                  ...
                  if (response.error == null) {
                    // Remover a demanda da lista local ou atualizar a UI
                    print('Demanda apagada com sucesso');
                  } else {
                    print('Erro ao apagar demanda: ${response.error?.message}');
                  }
                };
                print('Apagando demanda $nomeDemanda');
              },
            ),
          ],
        ),
